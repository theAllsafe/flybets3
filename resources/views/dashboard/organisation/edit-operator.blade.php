...
@section('content')
    <div class="mdk-drawer-layout__content page">
        ...
        <div class="container-fluid page__container">
            ...
            <form action="{{ route('uas-operator.updateByUser', $uas_operator->id)}}" method="POST"
                ...
                <div class="card card-form">
                        ...
                        <div class="col-lg-8 card-form__body card-body">
                            <div class="form-row">
                                ...
                                <div class="col-3 col-md-3 mb-3">
                                    ...
                                    <button class="btn btn-success form-control input-value">Download</button>
                                </div>
                                <div class="col-3 col-md-3 mb-3">
                                </div>
                            </div>
                    ...
                    <div style="border-top: solid 2px lightgray" class="row no-gutters">
                        ...
                        <div class="col-lg-8 card-form__body card-body">
                            ...
                            {{--                            <div class="form-row">--}}
                            {{--                                <div class="col-12 col-md-12 mb-3">--}}
                            {{--                                    <label for="type" class="form-title">Type of UAS Operator--}}
                            {{--                                        <span style="color: red; font-size: 18px">*</span> :</label>--}}
                            {{--                                    <select id="type" data-toggle="select" name="type"--}}
                            {{--                                            class="form-control input-value  @error('type') input-error @enderror">--}}
                            {{--                                        <option value="1" selected {{ $uas_operator->type == 1 ? 'selected' : ''--}}
                            {{--                                        }}>--}}
                            {{--                                            Individual--}}
                            {{--                                        </option>--}}
                            {{--                                        <option value="2" {{ $uas_operator->type == 2 ? 'selected' : '' }}>--}}
                            {{--                                            Organisation--}}
                            {{--                                        </option>--}}
                            {{--                                    </select>--}}
                            {{--                                    @error('type')--}}
                                        ...
                                        <div class="row">
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id=""
                                                       value="{{  $uas_operator->ssm_certificate }}">
                                            </div>
                    ...
                    <div class="row no-gutters" id="only-none">
                        ...
                        <div class="col-lg-8 card-form__body card-body" style="border-top: solid 2px lightgray">
                            ...
                            <a class="btn btn-danger" href="{{ route('uas-operator.index') }}">Cancel</a>
