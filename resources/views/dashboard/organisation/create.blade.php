...
@section('content')
    <div class="mdk-drawer-layout__content page">
        ...
        <div class="container-fluid page__container">
            <h4 class="card-header__title mb-3">Add an organisation</h4>
                ...
                <div class="card card-form">
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-lg-8 card-form__body card-body">
                            ...
                            <div class="form-row">
                                <div class="col-12 col-md-12 mb-3">
                                    <label for="registration_number" class="form-title">Registration Number
                                        <span style="color: red; font-size: 18px">*</span> :</label>
                                    <input type="text" id="registration_number" placeholder="Enter Registration Number"
                                           ...
                                           value="{{ old('registration_number') != null ? old('registration_number') : '' }}">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-6 col-md-6 mb-3">
                                    ...
                                    <input type="text" id="contact_number" placeholder="Enter Contact Official Numer"
                                           ...
                                           value="{{ old('contact_number') != null ? old('contact_number') : '' }}">
                        ...
                        <div class="col-lg-8 card-form__body card-body">
                            ...
                            <div class="form-row">
                                <div class="col-12 col-md-12 mb-3">
                                    ...
                                    <input type="text" id="address2" placeholder="Enter Address Line 2" name="address2"
                                           ...
                                           value="{{ old('address2') != null ? old('address2') : '' }}">
                                    @error('address2')
                                    <div class="invalid-feedback"
                                         style="display: block !important;">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="form-row">
                                <div class="col-12 col-md-12 mb-3">
                                    ...
                                    <input type="text" id="postcode" placeholder="Enter Postcode" name="postcode"
                                           ...
                                           value="{{ old('postcode') != null ? old('postcode') : '' }}">
                                    @error('postcode')
                                    <div class="invalid-feedback"
                                         style="display: block !important;">{{ $message }}</div>
                                    @enderror
                                    ...
                                    <select id="country" data-toggle="select" name="country"
                                        ...
                                        @foreach($countries as $country)
                                            <option value="{{ $country }}" {{ $country=='Malaysia' ? 'selected' : '' }}
                                                {{old('country') !=null && old('country' )==$country ? 'selected' : '' }}>
                                                {{ $country }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-row">
                                <div class="col-12 col-md-12 mb-3">
                                    ...
                                    <br>
                                    <input type="checkbox" id="terms" name="is_organisation_pilot">
                                    <label style="padding-top: 10px;color: gray;padding-left: 10px;" for="terms">
                                        Tick here if Yes</label>
                                </div>
                            </div>
                            {{-- @dd($errors) --}}
                            @if(auth()->user()->has_org)
                                <a class="btn btn-danger" type="submit"
                                   href="{{ route('organisation.index') }}">Cancel</a>
                            @else
                                <a class="btn btn-danger" type="submit" href="{{ route('dashboard') }}">Cancel</a>
                            @endif
                            <button class="btn btn-primary" type="submit" id="showSubmit" style="margin-left: 20px">Submit</button>
                        </div>
                    </div>
                </div>
            </form>
