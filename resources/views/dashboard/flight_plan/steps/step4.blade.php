<div class="step4">
    ...
    <div class="form-row">
        <div class="col-6 col-md-6 mb-3">
            <label for="end_date_time" style="color: blue">Area of Operator</label>
        </div>
        <div class="col-6 col-md-6 mb-3">
        </div>
    </div>
    ...
    <!-- Purpose section -->
     ...
     <div class="map_canvas map_canvasssss" id="map_canvasssss">
         
     </div>
    <div class="form-row">
        <div class="col-12 col-md-12 mb-3">
            <label for="purpose" class="form-title">purpose of flight plan :</label>
            <input type="text" class="form-control" id="final_purpose" disabled>
        </div>
    </div>
    <!-- Description section -->
    <div class="form-row">
    ...
    <div class="form-row">
        <div class="col-6 col-md-6 mb-3" style="margin-bottom: 1px !important">
            <label for="end_date_time" class="form-title" style="color: blue;padding-bottom: 0; font-weight: bold">UAS Pilot</label>
        </div>
        <div class="col-6 col-md-6 mb-3" style="margin-bottom: 1px !important">
            <label for="fly_less_120m" class="form-title" style="color: blue;padding-bottom: 0; font-weight: bold">
                Unmanned Aircraft
            </label>
        </div>
    </div>
    ...
    <div class="form-row">
        ...
        <div class="col-6 col-md-6 mb-3">
            <label for="last_name" class="form-title">Manufacture name :</label>
