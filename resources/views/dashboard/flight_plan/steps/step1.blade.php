<div>
    ...
    <form method="POST" action="{{ route('flight-plan.store') }}" enctype="multipart/form-data">
                    @csrf
    <input type="hidden" name="map_details" class="map_details">
    <div class="form-row">
        <div class="col-12 col-md-12 mb-3">
            ...
            <input type="text" placeholder="Enter Purpose of Flight Plan" name="purpose"
                   @isset($flight_plan->purpose)
                   value="{{ old('purpose') != null ? old('purpose') : $flight_plan->purpose}}"
                   @else value="{{ old('purpose') }}"
                   @endisset
                   class="form-control @error('purpose') input-error @enderror" required>
            <div class="invalid-feedback">
                <div class="validation-inputs" id="purpose-validation">
                    Error
                </div>
            </div>
            @error('purpose')
    ...
    <div class="form-row">
        <div class="col-12 col-md-12 mb-3">
            ...
            <textarea id="description" cols="30" rows="2" placeholder="Enter Description" name="description"
                      class="form-control @error('description') input-error @enderror" required>@isset($flight_plan->description){{ old('description') != null ? old('description') : $flight_plan->description }}@else{{ old('description') }} @endisset</textarea>
            @error('description')
            <div class="invalid-feedback" style="display: block !important;">{{ $message }}</div>
            @enderror
        </div>
    ...
    <div class="form-row">
        <div class="col-6 col-md-6 mb-3">
            ...
            <select id="timezone" data-toggle="select" name="timezone"
                    class="form-control  @error('timezone') input-error @enderror" required>
    ...
    <div class="form-row">
        <div class="col-6 col-md-6 mb-3">
            ...
            <input type="datetime-local" id="start_date_time" name="start_date_time"
                   ...
                   class="form-control @error('start_date_time') input-error @enderror"
                   value="{{ old('start_date_time') }}" {{-- @isset($flight_plan->start_date_time)--}}
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <input type="number" id="max_height" placeholder="0" min="0" name="max_height"
                           class="form-control @error('max_height') input-error @enderror"
                           @isset($flight_plan->max_height)
    ...
    <div class="form-row">
        <div class="col-6 col-md-6 mb-3">
            ...
            <input type="datetime-local" id="end_date_time" name="end_date_time" placeholder="Enter end date & time"
                   class="form-control @error('end_date_time') input-error @enderror"
                   @isset($flight_plan->end_date_time)
        ...
        <div class="col-6 col-md-6 mb-3">
            ...
            <br>
            <br>
            <input type="checkbox" id="fly_less_120m" name="fly_less_120m" required>
