...
{{--        {{ $uas_operator = }}--}}
    ...
    <div class="form-row">
        <div class="col-6 col-md-6 mb-3">flight_plan
            ...
            <input type="text" id="observer_mobile_number" name="observer_mobile_number"
                   value="{{ old('observer_mobile_number') != null ? old('observer_mobile_number') : $flight_plan->observer_mobile_number }}"
    ...
    <div class="form-row">
        <div class="col-12 col-md-12 mb-3">
            <label for="additional_information" class="form-title">additional information
                <span style="color: red; font-size: 18px">*</span> :</label>
            <textarea name="additional_information" id="additional_information" cols="25"
                      ...
                      rows="2">{{ isset($flight_plan->additional_information) ? $flight_plan->additional_information : '' }}</textarea>
